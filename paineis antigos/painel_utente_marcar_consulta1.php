  ...
  <p > 
        ...
        while($rows_pesquisar3 = mysqli_fetch_array($resultado_pesquisa3)){
            ...
            <div style="display: inline-flex; margin-left: 10px; align-items: center; justify-content: center; margin-top: 8px">
                <input type="checkbox" name="checkbox" value="<?php echo $rows_pesquisar3['questao']; ?>">
   
                  <input type="" hidden name="questao_1" value="<?php echo $rows_pesquisar3['questao']; ?>">
        ...
        while($rows_pesquisar3 = mysqli_fetch_array($resultado_pesquisa3)){
             ...
             <div style="display: inline-flex; margin-left: 10px; align-items: center; justify-content: center; margin-top: 8px">
                <input type="checkbox" name="checkbox" value="<?php echo $rows_pesquisar3['questao']; ?>">
                  ...
                  <input type="" hidden name="questao_2" value="<?php echo $rows_pesquisar3['questao']; ?>">
                  <label style="display: inline-flex; margin-left: 8px;"><strong><?php echo $rows_pesquisar3['questao']; ?></strong></label>
        ...
        while($rows_pesquisar3 = mysqli_fetch_array($resultado_pesquisa3)){
             ...
             <div style="display: inline-flex; margin-left: 10px; align-items: center; justify-content: center; margin-top: 8px">
                <input type="checkbox" name="checkbox" value="<?php echo $rows_pesquisar3['questao']; ?>">
                  ...
                  <input type="" hidden name="questao_3" value="<?php echo $rows_pesquisar3['questao']; ?>">
                  <label style="display: inline-flex; margin-left: 8px;"><strong><?php echo $rows_pesquisar3['questao']; ?></strong></label>
...
*/
    ...
    <style type="text/css">
      ...
      <input  type="submit" id="button" class="btn btn-success w-25" style="border-radius: 0px; float: right;" value="Marcar Consulta" name="button"/>
          <br>
        </div>
        </form>
     </form> 
