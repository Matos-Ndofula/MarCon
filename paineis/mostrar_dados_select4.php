...
$result_pesq = "SELECT id,nome, especialidade FROM medico WHERE especialidade = '$val'";
    ...
    if (mysqli_num_rows($resultado_pesquisa)>0) {
    	echo "<div class=' col-md-6 form-group mt-3 ms-0'>";
  		echo " <input type='text' name="" placeholder='Acrescentar' style='border-bottom: black solid 1px; border-top: transparent; border-right: transparent; border-left: transparent'>";
    	echo "</div>";
