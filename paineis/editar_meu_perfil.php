...
<?php
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
       <div class="card_body" style="padding: 10px; position: absolute;">
  ...
  width: 100%;height: 100%; color: #000">
               ...
               <p>Seja Bem-vindo ai sistema de consultas online</p>
             </div>
          <div class="card_corpo" style="display: inline-flex; margin-top: 20px;">
          
            <div class="botao_boas_vindas">
              
	         <a href="calendario_utente_consultas.php" class="btn btn-primary"><i class="bi bi-calendar-date-fill"></i>Calendário</a>
            </div>
          
            <div class="botao_boas_vindas">
          <a href="painel_utente_marcar_consulta.php" class="btn btn-primary">Marcar Consulta</a>
            </div>
          
            <div class="botao_boas_vindas">
          <a href="painel_utente_desmarcar_consulta.php" class="btn btn-primary">Desmarcar Consulta</a>
            </div>
          
            <div class="botao_boas_vindas">
          <a href="#" class="btn btn-primary">Editar Utentes</a>
            </div>
