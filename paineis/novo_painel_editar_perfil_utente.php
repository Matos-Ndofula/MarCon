...
<head>
  ...
  <title>Dashboard Painel Editar Perfil Utente</title>
  ...
  padding: 0 10px 20px 15px;
       ...
       .btn-acao a, #botao_cancelar a{
        ...
        .action-card_submit_editar {
         ...
         .action-card_submit_editar:hover { transform: translateY(-2px); 
          background: #2e5a82;
  ...
  ?>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block ps-2" id="dado"><?php echo $nome_utente; ?></span>
...
$pesq = "SELECT * FROM utente WHERE id='$id'";
  ...
  <div class="col-md-4 form-group mt-3 ">
     ...
     <div class="col-md-4 form-group mt-3">
      ...
      <div class="row" id="botao_cancelar">  
          <div class="col-md-12 form-group mt-3">
               <button id="button" type="submit" class="action-card_submit_editar" >Editar</button> 
              <a class="action-card_cancelar" href="novo_painel_utente_boas_vindas.php">Cancelar</a>
