...
<?php
  ...
  ?>
    ...
    <!-- Sidebar -->
      ...
      <aside id="sidebar" class="sidebar" class="header fixed-top d-flex align-items-center">
 ...
 <!-- Conteúdo Principal -->
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
       ...
       <a href="novo_painel_utente_marcar_consulta.php"><div class="action-card">
            <div class="action-icon bg-add"><i class="bi bi-file-medical"></i></div>
            <span class="fw-bold">Marcar Consulta</span>
        </div>
      </a>

        <a href="novo_painel_utente_desmarcar_consulta.php"><div class="action-card">
            <div class="action-icon bg-remove"><i class="bi bi-calendar-x"></i></div>
            <span class="fw-bold">Desmarcar Consulta</span>
        </div>
      </a>

       <a href="novo_calendario_utente_consultas.php">
            <div class="action-card">
            <div class="action-icon bg-calendar"><i class="bi bi-calendar-day"></i></div>
            <span class="fw-bold">Calendário</span>
        </div>
        </a>
...
$select = $mysqli->query("SELECT * FROM consultas_agendadas WHERE id='$id' AND estado ='Agendado'");
  ...
  <a type="button" class="bi bi-calendar-x" id="botao_desmarcar" onclick="abrirModalDialogo(<?php echo $id_agendado; ?>)"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Desmarcar Consulta" ></a>
...
$select = $mysqli->query("SELECT * FROM consultas_agendadas WHERE id='$id' AND estado ='Agendado'");
        ...
        if($row > 0){
           ...
           $id_remarcar = encryptor('encrypt', $rows_pesquisar['id']);  
   
      ?>
                  
  <a type="button" class="bi bi-bootstrap-reboot"   href ="novo_painel_remarcar_consulta.php?id=<?php echo $id_remarcar; ?>" id="botao_remarcar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Remarcar Consulta"></a>
      <?php
        }else{
