...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="header-nav ms-auto">
     ...
     <!--   <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="label label-pill label-danger count"></span>Notificacao</a>
    ...
    function load_unseen_notification(view = ''){
      $.ajax({
        ...
        success:function(data){
          $('.dropdown-menu').html(data.notificacao);
          if (data.unseen_notificacao > 0) {
            $('.count').html(data.unseen_notificacao);
          }
        }
      });
    }
  ...
  width: 100%;height: 20%; color: #000;  margin-top: 20px">
    ...
    <section id="appointment" class="appointment section-bg">
     <br>     
      ...
      <form action="#" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate id="form_consulta">
          <div class="row">
  ...
  ?>
            ...
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <label>Nome Utente  </label>
                ...
                <input type="text" name="nome_utente" id="nome_utente" class="form-control" value="<?php echo $nome_utente; ?>" required>     
...
*/
            ...
            <span></span>
            <p id="data"></p>
                <input type="date" min="<?php echo date("Y-m-d");?>" class="form-control" id="data_horario" name="data_horario" placeholder="Digite a Data" required  onchange = "selecione1();"  onclick="obterDiaSemana();">
                              <div class="validate"></div>
...
$rows_pesquisar4 = mysqli_fetch_array($resultado_pesquisa4);
    ...
    <div class="card" style="border: none;">
      ...
      <input  type="submit" id="button" class="btn btn-success w-50" style="border-radius: 0px; float: right;" value="Marcar Consulta" name="button"/>
