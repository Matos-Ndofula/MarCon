...
<head>
  ...
  <title>Dashboard Médico Atender Agenda</title>
  ...
  <!-- Sidebar -->
      ...
      <aside id="sidebar" class="sidebar">
        ...
        <li class="nav-item">
            ...
            <a href="novo_painel_medico.php" class="nav-link-custom"><i class="bi bi-house"></i> Home</a>
...
$pesq = "SELECT * FROM consultas_agendadas WHERE id='$id' ";
  ...
  $rows_pesquisar = mysqli_fetch_assoc($resultado_pesquisa);
    ...
    ?>
      <form action="atualiza_estado_atendido.php" method="POST">
   ...
   <div class="col-md-3 form-group mt-3">
        ...
        <div class="row">
          <div class="col-md-10 form-group mt-3">
             <div class='container'>
               <button id="button" type="submit"  class="btn btn-outline-success w-25"  id="botao_atender" >Atender Consulta</button> 
               </div>
           </div>
        </div>
...
<!---INICIO MODAL PARA meu_perfil_medico -->
...
$result_pesq = "SELECT * FROM medico";
    ...
    ?>         
        ...
        <!---FIM MODAL PARA meu_perfil_medico -->
