...
<head>
  ...
  <title>Dashboard Médico Confirmar Agenda</title>
...
$pesq = "SELECT * FROM consultas_agendadas WHERE id='$id' ";
  ...
  $rows_pesquisar = mysqli_fetch_assoc($resultado_pesquisa);
   ...
   <div class="col-md-10 form-group mt-3">
          ...
          <div class='container'>
               <button id="button" type="submit"  class="btn btn-outline-primary"  id="botao_confirmar" >Confirmar Consulta</button> 
          </div>
          </div>
