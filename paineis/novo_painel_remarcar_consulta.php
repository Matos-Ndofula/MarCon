  ...
  $rows_pesquisar = mysqli_fetch_assoc($resultado_pesquisa);
    ...
    <div class="row">
      <input hidden="" type="" name="id" value="<?php echo $id; ?>">
         ...
         <div class="col-md-4 form-group mt-3 mt-md-0">
               <span>Especialidade</span>(<span style="color: red">*</span>)
        ...
        <div class="row">
         ...
         <div class="col-md-12 form-group mt-3 mt-md-0">
              <span>Horários Disponíveis  </span>(<span style="color: red">*</span>)
...
<div class="invalid-feedback">Por favor digite o Título da Consulta!</div>
            ...
            <div class='container'>
               <button  id="botao_remarcar" id="button" type="submit"  class="btn btn-outline-warning w-25">Remarcar</button> 
          </div>
        </div>
...
$result_pesq = "SELECT * FROM utente";
    ...
    <a  id="button"  href="novo_painel_editar_perfil_utente.php?id=<?php echo $id; ?>" >
        <div class="action-card_submit">
